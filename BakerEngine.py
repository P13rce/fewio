...
# Amount of wins each baker has in total
...
def calc_loss_week(baker_contestents, baker):
    """Find the week in which a baker was eliminated"""
    currentWeek = "Week " + str(12 - len(baker_contestents))
    baker.weeks_eliminated[currentWeek] += 1


def simulate_wins(baker_list: list):
    """Runs one round of the simulation and save the data into each baker object"""
    currentWeek = 0
